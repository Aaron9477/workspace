...
def capture_vedio():
    capture = cv2.VideoCapture('/home/zq610/WYZ/media/video/TestVideo.mp4')
...
if __name__ == '__main__':
    ...
    caffemodel = os.path.join(cfg.DATA_DIR, '/home/zq610/WYZ/py-faster-rcnn/train_myself/test_model',
